...
default_temporal_params_dict        = {
    ...
    "train_period_end"      : datetime.strptime('01/01/19 00:00:00', global_strptime_str),
    "time_step_seconds"     : 5*60, #5 mins,
    "test_period_start"     : datetime.strptime('01/01/19 00:00:00', global_strptime_str),
    "test_period_end"       : datetime.strptime('01/07/19 00:00:00', global_strptime_str)
}
...
[1, 25, 7, 900, 1, 1, 4, 0, 1.00E-06, 25, 1],
[1, 25, 7, 900, 1, 1, 4, 0, 1.00E-06, 25, 0.5],
[1, 25, 7, 900, 1, 1, 4, 0, 1.00E-06, 25, 0.25],
#reg accuracy and speed test 1
#[1, 25, 7, 900, 1, 1, 4, 0, 1.00E-04, 25, 0.5],
#[1, 25, 7, 900, 1, 1, 4, 0, 1.00E-05, 25, 0.5],
#[1, 25, 7, 900, 1, 1, 4, 0, 1.00E-06, 25, 0.5],
#[1, 25, 7, 900, 1, 1, 4, 0, 1.00E-07, 25, 0.5],
#[1, 25, 7, 900, 1, 1, 4, 0, 1.00E-08, 25, 0.5],
##reg accuracy and speed test 2
#[2, 13, 3, 180, 1, 2, 5, 0, 1.00E-04, 40, 1],
#[2, 13, 3, 180, 1, 2, 5, 0, 1.00E-05, 40, 1],
#[2, 13, 3, 180, 1, 2, 5, 0, 1.00E-06, 40, 1],
#[2, 13, 3, 180, 1, 2, 5, 0, 1.00E-07, 40, 1],
#[2, 13, 3, 180, 1, 2, 5, 0, 1.00E-08, 40, 1],
]
...
for scenario_ID in loop:
    ...
    scenario_name_str = scenario_name_str + "regulisation_test.csv"
    ...
    if __name__ == '__main__':
        ...
        experiment_manager(
            ...
            global_record_path=os.path.join(global_general_folder,r"outputs/regulisation_test.csv")
            )
