...
global_tweets = os.path.join(global_general_folder, r"data/twitter_data/apple.csv")
global_cleaned_tweets = os.path.join(global_general_folder, r"data/twitter_data/apple_cleaned_for_topic_discovery.csv")
