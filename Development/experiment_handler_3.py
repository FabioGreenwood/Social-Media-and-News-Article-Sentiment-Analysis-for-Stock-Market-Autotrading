...
shard = 0
for scenario_ID in [shard]:#scenario_dict.keys():
    ...
    scenario_name_str = scenario_name_str + "parallel_run_" + str(shard)
    ...
    if __name__ == '__main__':
        ...
        experiment_manager(
            ...
            global_record_path=os.path.join(global_general_folder,r"outputs/parallel_run_" + str(shard) + "DOEPOP.csv")
            )
