...
init_doe = [
    ...
    [17, 13,   900,  0, 4, 1, 2, 2,	2, 1e-06, 50, 9],
    [13, 3,    7200, 0, 2, 0, 0, 3,	0, 1e-05, 8,  9],
    [5,  0.7,  25200,0, 4, 1, 1, 5,	3, 1e-09, 8,  0],
    [9,  0.7,  180,  1, 1, 0, 2, 3,	3, 1e-10, 15, 9],
    [13, 7,    180,  0, 2, 1, 0, 4,	3, 1e-06, 25, 0],
    [17, 7,    7200, 0, 1, 0, 0, 0,	2, 1e-09, 25, 12]
