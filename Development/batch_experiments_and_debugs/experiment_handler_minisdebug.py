...
init_doe = [
    [1, 9,  1,   722,   0, 2, 0, 0, 4, 3, 1.00E-09, 10, 7],   # 0
...
for scenario_ID in loop:
    ...
    scenario_name_str = scenario_name_str + "run21a_{}.csv".format(str(scenario_ID))
    ...
    if __name__ == '__main__':
        ...
        experiment_manager(
            ...
            global_record_path=os.path.join(global_general_folder,r"outputs/run21a_{}.csv".format(str(scenario_ID)))
            )
