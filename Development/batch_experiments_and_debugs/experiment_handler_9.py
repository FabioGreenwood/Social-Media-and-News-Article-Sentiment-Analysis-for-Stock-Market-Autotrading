...
init_doe = [
    ...
    [13,7,	7200,   1,	1,	0,	2,	0,	2,	1e-09,	15,	7],
    [9, 1,	180,    1,	4,	0,	1,	2,	2,	1e-11,	20,	5],
    [5, 1,	180,    1,	4,	0,	2,	1,	2,	1e-11,	10,	9],


    [17	,0.3 ,900	,0	,4	,1	,2	,3	,3	,0.0001	    ,50	,5],
    [17	,2	,900	,1	,2	,1	,1	,2	,2	,1e-06	,50	,5],
    [25	,13	,7200	,0	,1	,1	,2	,1	,2	,1e-11	,10	,5],
    [25	,7	,25200	,0	,2	,1	,2	,2	,3	,1e-05	,15	,9],
    [17	,2	,900	,1	,1	,1	,1	,2	,2	,1e-11	,50	,5],
    [17	,2	,900	,1	,2	,1	,0	,1	,2	,1e-11	,50	,5],
    [17	,2	,900	,1	,2	,1	,1	,2	,3	,1e-11	,50	,5],
    [0	,13	,7200	,0	,4	,0	,0	,5	,1	,0.0001	    ,10	,7]
...
for scenario_ID in loop:
    ...
    run_name_str = "run40_{}{}.csv".format(str(scenario_ID),final_str)
