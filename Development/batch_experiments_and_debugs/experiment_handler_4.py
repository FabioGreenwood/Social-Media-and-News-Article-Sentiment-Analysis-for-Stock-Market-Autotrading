...
init_doe = [
    ...
    [1	,1	,7200	,0,	2,	1,	0,	0,	2,	1e-05	,8	,7],
    [1	,13	,900	,0,	1,	1,	0,	2,	0,	1e-05    ,10	,5],
    [1	,1	,7200	,0,	2,	1,	0,	1,	1,	1e-11	,8	,7],
    [1	,1	,7200	,0,	2,	1,	0,	0,	3,	1e-05	,8	,7],
    [1	,13	,900	,0,	1,	1,	0,	0,	0,	1e-05    ,10	,5],
    [1	,2	,7200	,0,	2,	0,	0,	0,	2,	0.0001	    ,8	,9],
    [1	,2	,7200	,0,	2,	1,	0,	0,	2,	0.0001	    ,10	,7]
