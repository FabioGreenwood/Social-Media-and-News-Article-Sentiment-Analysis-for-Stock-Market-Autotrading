...
init_doe = [
    ...
    #[0, 6,  6,  1, 9, 1, 720,   0, 2, 4, 3, 1E-09, 10, 7],
    #[0, 7,  7,  1, 9, 1, 720,   0, 2, 4, 3, 1E-09, 10, 7],
    #[0, 8,  8,  1, 9, 1, 720,   0, 2, 4, 3, 1E-09, 10, 7],
    #[0, 9,  9,  1, 9, 1, 720,   0, 2, 4, 3, 1E-09, 10, 7],
    #[0,10, 10,  1, 9, 1, 720,   0, 2, 4, 3, 1E-09, 10, 7],
    #[0,11, 11,  1, 9, 1, 720,   0, 2, 4, 3, 1E-09, 10, 7],
    ### id 12
    ...
    #[0, 6,  6,  1, 13, 2, 7200, 1, 1, 2, 1, 1E-05, 25, 9],
    #[0, 7,  7,  1, 13, 2, 7200, 1, 1, 2, 1, 1E-05, 25, 9],
    #[0, 8,  8,  1, 13, 2, 7200, 1, 1, 2, 1, 1E-05, 25, 9],
    #[0, 9,  9,  1, 13, 2, 7200, 1, 1, 2, 1, 1E-05, 25, 9],
    #[0,10, 10,  1, 13, 2, 7200, 1, 1, 2, 1, 1E-05, 25, 9],
    #[0,11, 11,  1, 13, 2, 7200, 1, 1, 2, 1, 1E-05, 25, 9],
    ### id 14
    ...
    #[0, 6,  6,  1, 17, 7, 900,  1, 2, 5, 2, 1E-06, 20, 5],
    #[0, 7,  7,  1, 17, 7, 900,  1, 2, 5, 2, 1E-06, 20, 5],
    #[0, 8,  8,  1, 17, 7, 900,  1, 2, 5, 2, 1E-06, 20, 5],
    #[0, 9,  9,  1, 17, 7, 900,  1, 2, 5, 2, 1E-06, 20, 5],
    #[0,10, 10,  1, 17, 7, 900,  1, 2, 5, 2, 1E-06, 20, 5],
    #[0,11, 11,  1, 17, 7, 900,  1, 2, 5, 2, 1E-06, 20, 5],
    ### id 17
    ...
    #[0, 6,  6,  1, 25, 2, 7200, 0, 4, 4, 1, 0.0001, 10, 5],
    #[0, 7,  7,  1, 25, 2, 7200, 0, 4, 4, 1, 0.0001, 10, 5],
    #[0, 8,  8,  1, 25, 2, 7200, 0, 4, 4, 1, 0.0001, 10, 5],
    #[0, 9,  9,  1, 25, 2, 7200, 0, 4, 4, 1, 0.0001, 10, 5],
    #[0,10, 10,  1, 25, 2, 7200, 0, 4, 4, 1, 0.0001, 10, 5],
    #[0,11, 11,  1, 25, 2, 7200, 0, 4, 4, 1, 0.0001, 10, 5],
    ...
    #[0, 6,  6,  1, 25, 13, 25200, 1, 2, 4, 1, 1E-07, 10, 7],
    #[0, 7,  7,  1, 25, 13, 25200, 1, 2, 4, 1, 1E-07, 10, 7],
    #[0, 8,  8,  1, 25, 13, 25200, 1, 2, 4, 1, 1E-07, 10, 7],
    #[0, 9,  9,  1, 25, 13, 25200, 1, 2, 4, 1, 1E-07, 10, 7],
    #[0,10, 10,  1, 25, 13, 25200, 1, 2, 4, 1, 1E-07, 10, 7],
    #[0,11, 11,  1, 25, 13, 25200, 1, 2, 4, 1, 1E-07, 10, 7],
    ...
    #[0, 6,  6,  1, 9,  13, 7200,  1, 2, 2, 0, 0.0001, 20, 7],
    #[0, 7,  7,  1, 9,  13, 7200,  1, 2, 2, 0, 0.0001, 20, 7],
    #[0, 8,  8,  1, 9,  13, 7200,  1, 2, 2, 0, 0.0001, 20, 7],
    #[0, 9,  9,  1, 9,  13, 7200,  1, 2, 2, 0, 0.0001, 20, 7],
    #[0,10, 10,  1, 9,  13, 7200,  1, 2, 2, 0, 0.0001, 20, 7],
    #[0,11, 11,  1, 9,  13, 7200,  1, 2, 2, 0, 0.0001, 20, 7],
    ...
    [0, 6,  6,  1, 25, 13, 900, 1, 2, 4, 1, 1E-07, 10, 7],
    [0, 7,  7,  1, 25, 13, 900, 1, 2, 4, 1, 1E-07, 10, 7],
    [0, 8,  8,  1, 25, 13, 900, 1, 2, 4, 1, 1E-07, 10, 7],
    [0, 9,  9,  1, 25, 13, 900, 1, 2, 4, 1, 1E-07, 10, 7],
    [0,10, 10,  1, 25, 13, 900, 1, 2, 4, 1, 1E-07, 10, 7],
    [0,11, 11,  1, 25, 13, 900, 1, 2, 4, 1, 1E-07, 10, 7],
        ## id 11
    ...
    [0, 6,  6,  1, 25, 2, 7200, 0, 4, 4, 1, 1E-05, 10, 5],
    [0, 7,  7,  1, 25, 2, 7200, 0, 4, 4, 1, 1E-05, 10, 5],
    [0, 8,  8,  1, 25, 2, 7200, 0, 4, 4, 1, 1E-05, 10, 5],
    [0, 9,  9,  1, 25, 2, 7200, 0, 4, 4, 1, 1E-05, 10, 5],
    [0,10, 10,  1, 25, 2, 7200, 0, 4, 4, 1, 1E-05, 10, 5],
    [0,11, 11,  1, 25, 2, 7200, 0, 4, 4, 1, 1E-05, 10, 5],
    ...
    [0, 6,  6,  1, 25, 13, 25200, 1, 2, 2, 0, 0.0001, 10, 7],
    [0, 7,  7,  1, 25, 13, 25200, 1, 2, 2, 0, 0.0001, 10, 7],
    [0, 8,  8,  1, 25, 13, 25200, 1, 2, 2, 0, 0.0001, 10, 7],
    [0, 9,  9,  1, 25, 13, 25200, 1, 2, 2, 0, 0.0001, 10, 7],
    [0,10, 10,  1, 25, 13, 25200, 1, 2, 2, 0, 0.0001, 10, 7],
    [0,11, 11,  1, 25, 13, 25200, 1, 2, 2, 0, 0.0001, 10, 7]
    ]
...
for scenario_ID in loop:
    ...
    scenario_name_str = scenario_name_str + "time_shift_test_of_run13_shortertraining{}.csv".format(str(scenario_ID))
    ...
    if __name__ == '__main__':
        ...
        experiment_manager(
            ...
            global_record_path=os.path.join(global_general_folder,r"outputs/time_shift_test_of_run13_shortertraining{}.csv".format(str(scenario_ID)))
            )
