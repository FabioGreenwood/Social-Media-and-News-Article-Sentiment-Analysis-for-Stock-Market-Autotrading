...
[1, 25, 7, 900, 1, 1, 4, 0, 1.00E-04, 25, 1],
[1, 25, 7, 900, 1, 1, 4, 0, 1.00E-05, 25, 1],
[1, 25, 7, 900, 1, 1, 4, 0, 1.00E-06, 25, 1],
[1, 25, 7, 900, 1, 1, 4, 0, 1.00E-07, 25, 1],
[1, 25, 7, 900, 1, 1, 4, 0, 1.00E-08, 25, 1],
...
for scenario_ID in loop:
    ...
    scenario_name_str = scenario_name_str + "regulisation_test2.csv"
    ...
    if __name__ == '__main__':
        ...
        experiment_manager(
            ...
            global_record_path=os.path.join(global_general_folder,r"outputs/regulisation2_test.csv")
            )
