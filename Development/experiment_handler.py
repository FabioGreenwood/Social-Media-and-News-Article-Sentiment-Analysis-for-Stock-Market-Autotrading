...
default_temporal_params_dict        = {
    ...
    "train_period_end"      : datetime.strptime('01/04/16 00:00:00', global_strptime_str), #placeholder
    ...
    "test_period_end"       : datetime.strptime('01/09/20 00:00:00', global_strptime_str),#placeholder
