...
[2,	13,	3,      180,    1,	2,	5,	0,	1.00E-06,	40], # ID: 5
[2,	9,	0.3,    7200,   0,	1,	1,	1,	1.00E-05,	25], 
[1,	9,	1,      25200,  1,	4,	3,	1,	1.00E-04,	40],
[2,	13,	0.3,    25200,  0,	4,	0,	2,	1.00E-03,	20],
[2,	9,	7,      7200,   0,	4,	3,	1,	1.00E-02,	40],
...
[2,	9,	3,      25200,  1,	1,	2,	1,	1.00E-06,	40], # ID: 15
[2,	5,	7,      7200,   0,	4,	3,	3,	1.00E-05,	20],
[2,	13,	5,      25200,  0,	4,	2,	3,	1.00E-04,	10],
[2,	5,	7,      25200,  1,	4,	2,	0,	1.00E-03,	10],
[1,	17,	7,      180,    1,	1,	2,	2,	1.00E-02,	20],
[2,	25,	0.7,    25200,  0,	1,	3,	1,	1.00E-11,	15], # ID: 20
[2,	13,	2,      25200,  0,	4,	1,	3,	1.00E-10,	30],
[1,	13,	13,     7200,   1,	2,	3,	1,	1.00E-09,   8],
[1,	5,	1,      900,    0,	1,	0,	3,	1.00E-08,	30],
[1,	17,	3,      7200,   1,	1,	1,	1,	1.00E-07,	10],
]
...
for scenario_ID in loop:
    ...
    if __name__ == '__main__':
        ...
        experiment_manager(
            ...
            global_record_path=os.path.join(global_general_folder,r"outputs/parallel_run_6_{}.csv".format(str(shard)))
            )
